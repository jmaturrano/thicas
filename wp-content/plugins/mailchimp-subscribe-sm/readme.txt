...
Q. How can I export subscribers data from MailChimp Subscribe form plugin ?

A. If you use database save method you can export all your subscribers via a .csv file.
